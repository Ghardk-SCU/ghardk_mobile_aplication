               ...
               child: Column(
                 ...
                 children: [
                   Image.asset('assets/images/emptyaddress.png',
                     ...
                     scale: 1.1,),
                   SizedBox(height: 10),
                   Text('Addresses list is empty' , style: TextStyle(fontSize: 24 , color: kMainColor ,fontWeight: FontWeight.w600)),
                   SizedBox(height: 5),
                   Text('Add an address to use for upcoming orders' , style: TextStyle(fontSize: 16 , color: Color.fromARGB(99, 33, 51, 153),fontWeight: FontWeight.w400)),
                   SizedBox(height: 30),
                   accountInfoButton(ontap: () {}, text: 'Add Address'),
                 ],
               ),
             ),
           ),
