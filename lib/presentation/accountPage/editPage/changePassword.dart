           ...
           Padding(
             ...
             child: Column(
               children: [
                  ...
                  const SizedBox(height: 20),
                  const accountInfoPasswordTextField(text: 'Confirm New Password'),
...
class accountInfoPasswordTextField extends StatefulWidget {
  ...
  final String text ; 
  @override
  State<accountInfoPasswordTextField> createState() => _accountInfoPasswordTextFieldState();
}

class _accountInfoPasswordTextFieldState extends State<accountInfoPasswordTextField> {
  @override
